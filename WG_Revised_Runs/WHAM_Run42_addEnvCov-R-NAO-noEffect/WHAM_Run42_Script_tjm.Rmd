...
WHAM_Run42 <- fit_wham(input, do.osa = FALSE, do.retro = TRUE) 
x = make_osa_residuals(WHAM_Run42)
...
```{r}
#first just inspecting fit
WHAM_Run42 <- fit_wham(input, do.osa = F, do.retro = F)
